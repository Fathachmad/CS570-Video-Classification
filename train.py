...
def run(mode_dir, split_path, split, root, resume, init_lr=0.1, max_steps=args.steps, mode='opt',
    ...
    train_transforms = transforms.Compose([VideoTransform.RandomCrop(224),
                                           VideoTransform.RandomHorizontalFlip(),
                                           ])
    test_transforms = transforms.Compose([VideoTransform.CenterCrop(224)])
